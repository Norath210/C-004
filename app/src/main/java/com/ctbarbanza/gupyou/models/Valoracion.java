...
public class Valoracion extends Dato{
    ...
    public enum TIPO_VALORACION{
        ...
        private static final List<TIPO_VALORACION> VALUES = getAllValues();

        private static List<TIPO_VALORACION> getAllValues() {
            ArrayList<TIPO_VALORACION> list = new ArrayList<>();
            list.add(TIPO_VALORACION.GENERAL);
            list.add(TIPO_VALORACION.DINERO);
            list.add(TIPO_VALORACION.POSTUREO);
            list.add(TIPO_VALORACION.HIGIENE);
            return list;
        }
